...
public class UserRepositoryTest {
    ...
    Article article1 = new Article(null, "article", image, "article", user1, ELanguage.ANGULAR);
    articleRepository.save(article1);
    Article article2 = new Article(null, "article", image, "article", user1, ELanguage.ANGULAR);
    articleRepository.save(article2);
    Comment comment1 = new Comment(null, user1, article1);
    Comment comment2= new Comment(null, user2, article1);
    Comment comment3= new Comment(null, user3, article2);
    commentRepository.save(comment1);
    Comment comment = commentRepository.save(comment2);
    commentRepository.save(comment3);
    Long user_id = userRepository.findUserByCommentId(comment.getId());
